...
class Installer {
	 ...
	 * @var array
	 */
	private $dirs = array('/uploads', '/assets/avatars', '/application/storage', '/application/storage/app', '/application/storage/framework', '/application/storage/yaml-translation', '/application/storage/logs');
	...
	public function createAdmin($input)
	{
        ...
        \App\Folder::create(['name' => 'root', 'share_id' => str_random(15), 'user_id' => $user->id, 'description' => trans('app.rootAlbumDesc')]);
    ...
    {
        $response = $this->testAndFixHtaccessFile();
